...
//! MECHANICS: Re-exports versioned domain contracts for identity, sessions, plugins, events, policy, audit, discovery, capabilities, architecture graph, module orchestration and Round Table collaboration.
//! SYSTEM PART: Darkstar Core
//! ARCHITECTURE FUNCTION: Shared trusted-core foundation for all transports, plugins, workflows and human/agent control surfaces.
